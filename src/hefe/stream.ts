...
export class Stream {
    ...
    public constructor(text?: string, array?: Stream[], num?: number, bool?: boolean, map?: Map<IKey, Stream>){
        ...
        this.array = array ?? undefined;
        this.num = num ?? undefined;
        this.bool = bool ?? undefined;
        this.map = map ?? undefined;
    }
    public static mkText(text: string): Stream{ return new Stream(text);}
    public static mkArr(arr: Stream[]): Stream{ return new Stream(undefined, arr);}
    public static mkNum(num: number): Stream{ return new Stream(undefined, undefined, num);}
    public static mkBool(bool: boolean): Stream{ return new Stream(undefined, undefined, undefined, bool);}
    public static mkMap(map: Map<IKey,Stream>): Stream{ return new Stream(undefined, undefined, undefined, undefined, map);}
    public copy(): Stream {
    ...
    public runOp(op: string, other: Stream): Stream{
        switch (op) {
            case "=": return new Stream(undefined, undefined, undefined, Stream.areEqual(this,other));
            case "!=": return new Stream(undefined, undefined, undefined, !Stream.areEqual(this,other));
            ...
            case "+":
                ...
                switch (this.type) {
                    ...
                    case eStreamType.Array: return Stream.mkArr([...this.array!, ...other.asArray()]);
    ...
    public toRaw(): string | number | boolean | Stream[] | undefined | Map<IKey,Stream> {
    ...
    public static fromObj(obj: any): Stream {
        ...
        if(obj == null) throw  new Error('did not expect null stream');
    ...
    public toObj(): any {
        ...
        if(this.isNum) return this.num;
        if(this.isBool) return this.bool;
        if(this.isArray) return this.array!.map(c => c.toObj());
        if(this.isMap) {
            let obj: any = {};
            for(let pair of this.map!.entries()){
    ...
    public getChild(idx: Stream): Stream | undefined{
